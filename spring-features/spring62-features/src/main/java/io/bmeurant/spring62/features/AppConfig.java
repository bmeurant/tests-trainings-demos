...
import io.bmeurant.spring62.features.spel.SpelConfig;
...
@Import({AutowiringConfig.class, FallbackConfig.class, SpelConfig.class}) // Import the feature-specific configurations
